...
export default function Home() {
  ...
  const events = [
    ...
    {
      title: 'Glow & Go - A Sparkling Day for Moms & Kids with Cikal X SKINDA Clinic',
      date: '01 May 2025',
      price: 'Rp200.000',
      organizer: 'Sekolah Cikal',
    },
      ...
      <div className="flex max-w-7xl mx-auto mt-8 px-4">
        ...
        <aside className="w-1/4 bg-white p-6 rounded-lg shadow-md">
          ...
          <p className="text-sm text-gray-600 mt-4">
            Cikal dikenal sebagai komunitas pelajar sepanjang hayat yang berpusat pada anak sebagai subyek pendidikan.
          </p>
          <p className="text-sm text-gray-600 mt-2">
            Cikal mencakup Rumah Main Cikal (pra sekolah) dan Sekolah Cikal (taman kanak-kanak sampai sekolah menengah).
          </p>
          <p className="text-sm text-gray-600 mt-2">
            Jl. Lebak Bulus II no. 16A, Cilandak, Jakarta Selatan
          </p>
          <div className="mt-4">
            <a href="#" className="text-blue-500 hover:underline text-sm">Organizer Facebook</a>
          </div>
        </aside>
        ...
        <div className="flex-1 ml-6">
          ...
          <div className="flex justify-between items-center mt-4">
            <p className="text-sm text-gray-600">Menampilkan 1 - 8 dari total 13 events</p>
          ...
          <div className="flex justify-between items-center mt-6">
            ...
            <div className="flex space-x-2">
              <button className="border rounded px-3 py-1 text-sm hover:bg-gray-200">1</button>
              <button className="border rounded px-3 py-1 text-sm hover:bg-gray-200">2</button>
            </div>
          </div>
