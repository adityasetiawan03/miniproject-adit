  ...
  const [events] = useState([
    {
      ...
      image: "https://assets.loket.com/neo/production/images/banner/20250409132921_67f613c12a144.jpg",
    },
    {
      ...
      image: "https://assets.loket.com/neo/production/images/banner/20250423140359_680890df1dadd.jpg",
    },
    {
      ...
      image: "https://assets.loket.com/neo/production/images/banner/20250423175426_6808c6e28ccbb.jpg",
    },
    {
        ...
        <div>
          <details className="collapse">
            ...
            <div className="collapse-content">
              <input type="text" className="input input-sm w-full" placeholder="Cari Lokasi..." />
            </div>
          </details>
        </div>
