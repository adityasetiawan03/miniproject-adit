...
const eventsData = [
  {
    ...
    date: '03 May 2025',
    price: 'Rp35.000',
    imageUrl: 'https://assets.loket.com/neo/production/images/banner/20250228034628_67c0cf247fff4.jpg',
  ...
  },
  {
    ...
    date: '03 May 2025',
    price: 'Rp30.000',
    imageUrl: 'https://assets.loket.com/neo/production/images/banner/20250415131719_67fdf9efc7c25.jpg',
    location: 'Surabaya',
    eventType: 'Bazaar',
    topic: 'K-pop',
    online: false,
  ...
  },
  {
    ...
    date: '04 May 2025',
    price: 'Rp25.000',
    imageUrl: 'https://assets.loket.com/neo/production/images/banner/20250416204233_67ffb3c90bc3e.jpg',
    location: 'Purwakarta',
    eventType: 'Festival',
    topic: 'Music',
    online: true,
  ...
  },
  {
    ...
    price: 'Rp50.000',
    imageUrl: 'https://assets.loket.com/neo/production/images/banner/20250425182144_680b7048b341f.jpg',
    location: 'Bandung',
    eventType: 'Concert',
    topic: 'Music',
    online: false,
  ...
  },
  {
    ...
    price: 'Gratis',
    imageUrl: 'https://assets.loket.com/neo/production/images/banner/20250419124210_680337b2dfe4f.jpg',
    location: 'Jakarta',
  ...
  },
  {
    ...
    date: '29 Apr 2025',
    price: 'Rp350.000',
    imageUrl: 'https://assets.loket.com/neo/production/images/banner/20240517052506.jpg',
    location: 'Surabaya',
    eventType: 'Workshop',
    topic: 'Business',
    online: false,
...
export default function EventsPage() {
  ...
  const filteredEvents = currentEvents.filter((event) => {
    ...
    if (filter.location && !event.location.includes(filter.location)) return false;
      ...
      <aside className="w-full md:w-64 bg-gray-100 p-6 rounded-md">
        ...
        <div className="mt-4">
          ...
          >
            ...
            <option value="Festival, Fair, Bazaar">Festival, Fair, Bazaar</option>
            <option value="Konser">Konser</option>
            <option value="Pertandingan">Pertandingan</option>
            <option value="Exhibition, Expo, Pameran">Exhibition, Expo, Pameran</option>
        ...
        <div className="mt-4">
          ...
          >
            ...
            <option value="Hobi, Kerajinan Tangan">Hobi, Kerajinan Tangan</option>
      ...
      <main className="flex-grow p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
          {filteredEvents.map((event, idx) => (
            <div key={idx} className="bg-white shadow-md rounded-md overflow-hidden text-sm">
              <a href={event.link}>
                <img
                  src={event.imageUrl}
                  alt={event.title}
