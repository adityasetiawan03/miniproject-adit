...
const E_Voucher: React.FC = () => {
  const voucherData = {
    ...
    ticketUrl: "https://evoucher.loket.com/evoucher/4f741be8-a963-451a-8870-83eccde0e913?_gl=1*5a7u0a*_gcl_au*MTU3ODQ1NzI5NC4xNzQ1OTg3NzY2",
    supportEmail: "support@loket.com",
    supportPhone: "+62 213 0003 160",
    website: "https://www.loket.com/",
    eventBanner: "https://assets.loket.com/neo/production/images/banner/20250429133940_6810742c07c7f.jpg", // URL gambar banner
    barcodeImage: "https://png.pngtree.com/png-vector/20220605/ourmid/pngtree-barcode-vector-png-image_4889246.png", // URL barcode
  };
    ...
    <div style={{ fontFamily: 'Arial, sans-serif', padding: '20px', maxWidth: '1000px', margin: '0 auto' }}>
      ...
      <div style={{ marginTop: '20px', border: '1px solid #ccc', borderRadius: '8px', padding: '10px', display: 'flex', justifyContent: 'space-between' }}>
        ...
        <div style={{ width: '48%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
          ...
          <div style={{ marginBottom: '5px' }}>
            <p style={{ margin: '0 0 5px 0' }}><strong>Kode Tagihan / Invoice Code:</strong></p>
        ...
        <div style={{ width: '48%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
          ...
          <div style={{ marginBottom: '5px' }}>
            <p style={{ margin: '0 0 5px 0' }}><strong>Referensi / Reference:</strong></p>
      ...
      <div style={{ marginTop: '20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <div style={{ flex: 1, textAlign: 'center' }}>
          {/* Barcode Image */}
          <img src={voucherData.barcodeImage} alt="Barcode" style={{ width: '100%', maxWidth: '150px' }} />
        </div>
      </div>
      ...
      <div style={{ marginTop: '20px', fontSize: '12px' }}>
        ...
        <p>Telepon: <a href={`tel:${voucherData.supportPhone}`}>{voucherData.supportPhone}</a></p>
        <p>Website: <a href={voucherData.website} target="_blank" rel="noopener noreferrer">{voucherData.website}</a></p>
      </div>
    </div>
  );
};
