    ...
    >
      ...
      <SwiperSlide>
        <div className="bg-white shadow-md rounded-md overflow-hidden text-sm">
          ...
          />
          <div className="p-3">
            <h3 className="text-sm font-semibold leading-tight">Grand Final Ambassadors of UPH Medan Campus 2025</h3>
            <p className="mt-1 text-gray-600 text-xs">26 Apr 2025</p>
            <p className="text-sm font-bold mt-1">Rp200.000</p>
            <p className="mt-1 text-gray-500 text-xs">Ambassadors of UPH Medan Campus</p>
          </div>
        </div>
      </SwiperSlide>
      ...
      <SwiperSlide>
        <div className="bg-white shadow-md rounded-md overflow-hidden text-sm">
          ...
          />
          <div className="p-3">
            <h3 className="text-sm font-semibold leading-tight">YES CONFERENCE</h3>
      ...
      <SwiperSlide>
        <div className="bg-white shadow-md rounded-md overflow-hidden text-sm">
          ...
          />
          <div className="p-3">
            <h3 className="text-sm font-semibold leading-tight">Flow World Tour "Anime Shibari 2024 - 2025" - Jakarta</h3>
            <p className="mt-1 text-gray-600 text-xs">02 May 2025</p>
            <p className="text-sm font-bold mt-1">Rp1.000.000</p>
            <p className="mt-1 text-gray-500 text-xs">PT. FRIEDRICE ENTERTAINTAMENT INDONESIA</p>
          </div>
        </div>
      </SwiperSlide>
      ...
      <SwiperSlide>
        <div className="bg-white shadow-md rounded-md overflow-hidden text-sm">
          ...
          />
          <div className="p-3">
            <h3 className="text-sm font-semibold leading-tight">SUPERMUSIC INTIMATE SESSIONS 2025 - MADIUN</h3>
      ...
      <SwiperSlide>
        <div className="bg-white shadow-md rounded-md overflow-hidden text-sm">
          ...
          />
          <div className="p-3">
            <h3 className="text-sm font-semibold leading-tight">Jazz Festival 2025</h3>
      ...
      <SwiperSlide>
        <div className="bg-white shadow-md rounded-md overflow-hidden text-sm">
          ...
          />
          <div className="p-3">
            <h3 className="text-sm font-semibold leading-tight">Tech Expo 2025</h3>
            <p className="mt-1 text-gray-600 text-xs">10 May 2025</p>
            <p className="text-sm font-bold mt-1">Rp200.000</p>
            <p className="mt-1 text-gray-500 text-xs">Technology Showcase</p>
          </div>
        </div>
      </SwiperSlide>
      ...
      <SwiperSlide>
        <div className="bg-white shadow-md rounded-md overflow-hidden text-sm">
          ...
          />
          <div className="p-3">
            <h3 className="text-sm font-semibold leading-tight">Music Concert 2025</h3>
      ...
      <SwiperSlide>
        <div className="bg-white shadow-md rounded-md overflow-hidden text-sm">
          ...
          />
          <div className="p-3">
            <h3 className="text-sm font-semibold leading-tight">Art Exhibition 2025</h3>
            <p className="mt-1 text-gray-600 text-xs">20 May 2025</p>
            <p className="text-sm font-bold mt-1">Rp120.000</p>
            <p className="mt-1 text-gray-500 text-xs">Contemporary Art Show</p>
          </div>
        </div>
      </SwiperSlide>
      ...
      <SwiperSlide>
        <div className="bg-white shadow-md rounded-md overflow-hidden text-sm">
          ...
          />
          <div className="p-3">
            <h3 className="text-sm font-semibold leading-tight">Food Festival 2025</h3>
            <p className="mt-1 text-gray-600 text-xs">25 May 2025</p>
            <p className="text-sm font-bold mt-1">Rp90.000</p>
            <p className="mt-1 text-gray-500 text-xs">Gastronomic Experience</p>
          </div>
        </div>
      </SwiperSlide>
      ...
      <SwiperSlide>
        <div className="bg-white shadow-md rounded-md overflow-hidden text-sm">
          ...
          />
          <div className="p-3">
            <h3 className="text-sm font-semibold leading-tight">Film Screening 2025</h3>
...
<section className="mt-12">
<h2 className="text-2xl font-bold text-left">Rekomendasi Event Terkini</h2>
<div className="mt-6 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
    {/* Event Card 1 */}
    <div className="bg-white shadow-md rounded-md overflow-hidden text-sm">
      <img
...
{/* Event Pilihan Section */}
<section className="mt-12">
  <h2 className="text-2xl font-bold text-center">Nikmati Keseruan Minggu Ini</h2>
  <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
...
<section className="mt-4">
  ...
  <div className="flex overflow-x-auto space-x-4 pb-2">
    ...
    {/* Anak, Keluarga */}
    <div className="flex items-center bg-white shadow rounded-lg p-3 min-w-[250px]" onClick={() => alert('Anak, Keluarga clicked')}>
      <img src="https://cdn-icons-png.flaticon.com/128/3088/3088392.png" alt="Anak, Keluarga" className="w-12 h-12 object-contain" />
      <div className="ml-3">
    ...
    {/* Bisnis */}
    <div className="flex items-center bg-white shadow rounded-lg p-3 min-w-[250px]" onClick={() => alert('Bisnis clicked')}>
      <img src="https://cdn-icons-png.flaticon.com/128/9139/9139670.png" alt="Bisnis" className="w-12 h-12 object-contain" />
      <div className="ml-3">
    ...
    {/* Desain, Foto, Video */}
    <div className="flex items-center bg-white shadow rounded-lg p-3 min-w-[250px]" onClick={() => alert('Desain, Foto, Video clicked')}>
      <img src="https://cdn-icons-png.flaticon.com/128/6088/6088711.png" alt="Desain, Foto, Video" className="w-12 h-12 object-contain" />
      <div className="ml-3">
    ...
    {/* Fashion, Kecantikan */}
    <div className="flex items-center bg-white shadow rounded-lg p-3 min-w-[250px]" onClick={() => alert('Fashion & Beauty clicked')}>
      <img src="https://cdn-icons-png.flaticon.com/128/2684/2684489.png" alt="Fashion" className="w-12 h-12 object-contain" />
      <div className="ml-3">
    ...
    {/* Film, Sinema */}
    <div className="flex items-center bg-white shadow rounded-lg p-3 min-w-[250px]" onClick={() => alert('Film & Sinema clicked')}>
      <img src="https://cdn-icons-png.flaticon.com/128/1/1854.png" alt="Film" className="w-12 h-12 object-contain" />
      <div className="ml-3">
    ...
    {/* Game, E-Sports */}
    <div className="flex items-center bg-white shadow rounded-lg p-3 min-w-[250px]" onClick={() => alert('Game & E-Sports clicked')}>
      <img src="https://cdn-icons-png.flaticon.com/128/686/686589.png" alt="Game" className="w-12 h-12 object-contain" />
      <div className="ml-3">
    ...
    <div className="flex items-center bg-white shadow rounded-lg p-3 min-w-[250px]" onClick={() => alert('Hobi & Kerajinan clicked')}>
      <img src="https://cdn-icons-png.flaticon.com/128/7081/7081352.png" alt="Hobi" className="w-12 h-12 object-contain" />
      <div className="ml-3">
    ...
    {/* Investasi, Saham */}
    <div className="flex items-center bg-white shadow rounded-lg p-3 min-w-[250px]" onClick={() => alert('Investasi & Saham clicked')}>
      <img src="https://cdn-icons-png.flaticon.com/128/2300/2300422.png" alt="Investasi" className="w-12 h-12 object-contain" />
      <div className="ml-3">
    ...
    <div className="flex items-center bg-white shadow rounded-lg p-3 min-w-[250px]" onClick={() => alert('Karir & Diri clicked')}>
      <img src="https://cdn-icons-png.flaticon.com/128/10822/10822278.png" alt="Karir" className="w-12 h-12 object-contain" />
      <div className="ml-3">
    ...
    {/* Keagamaan */}
    <div className="flex items-center bg-white shadow rounded-lg p-3 min-w-[250px]" onClick={() => alert('Keagamaan clicked')}>
      <img src="https://cdn-icons-png.flaticon.com/128/11475/11475091.png" alt="Keagamaan" className="w-12 h-12 object-contain" />
      <div className="ml-3">
...
{/* Event Pilihan Section */}
<section className="mt-12">
<h2 className="text-2xl font-bold text-left">Nikmati Keseruan Minggu Ini</h2>
<div className="mt-6 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
    {/* Event Card 1 (sama dengan sebelumnya) */}
    <div className="bg-white shadow-md rounded-md overflow-hidden text-sm">
      <img
