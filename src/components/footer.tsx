          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="hover:underline">Tentang Loket</a></li>
                <li><a href="#" className="hover:underline">Masuk</a></li>
                <li><a href="#" className="hover:underline">Biaya</a></li>
                <li><a href="#" className="hover:underline">Lihat Event</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="hover:underline">Cara Mempersiapkan Event</a></li>
                <li><a href="#" className="hover:underline">Cara Membuat Event Lomba</a></li>
                <li><a href="#" className="hover:underline">Cara Mempublikasikan Event</a></li>
                <li><a href="#" className="hover:underline">Cara Membuat Event Musik</a></li>
                <li><a href="#" className="hover:underline">Cara Mengelola Event</a></li>
                <li><a href="#" className="hover:underline">Cara Membuat Konsep Acara yang Menarik</a></li>
                <li><a href="#" className="hover:underline">Cara Membuat Event di Co-Working Space</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="hover:underline">Jakarta</a></li>
                <li><a href="#" className="hover:underline">Bandung</a></li>
                <li><a href="#" className="hover:underline">Yogyakarta</a></li>
                <li><a href="#" className="hover:underline">Surabaya</a></li>
                <li><a href="#" className="hover:underline">Solo</a></li>
                <li><a href="#" className="hover:underline">Medan</a></li>
                <li><a href="#" className="hover:underline">Bali</a></li>
                <li><a href="#" className="hover:underline">Semua Kota</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="hover:underline">Konser</a></li>
                <li><a href="#" className="hover:underline">Olahraga</a></li>
                <li><a href="#" className="hover:underline">Workshop & Seminar</a></li>
                <li><a href="#" className="hover:underline">Teater & Drama</a></li>
                <li><a href="#" className="hover:underline">Atraksi</a></li>
                <li><a href="#" className="hover:underline">Semua Kategori</a></li>
              </ul>
            </div>
          </div>
...
<div className="flex flex-col items-center py-8">
  <p className="text-sm font-medium text-white text-center mb-4">Ikuti Kami</p>
